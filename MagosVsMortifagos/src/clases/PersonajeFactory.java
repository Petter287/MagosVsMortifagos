...
public class PersonajeFactory {
	// Se pensó que este será el estado inicial de la vida, si está armado y si está
	// protegido.
	...
	public static Mago crearMago(TipoMago tipo, String nombrePersonaje) {
		...
		// Se pensó que los magos conozcan todos los mismos hechizos, pero su daño es en
		// base a su nivel mágico
	...
	public static Mortifago crearMortifago(TipoMortifago tipo, String nombrePersonaje) {
		...
		// Se pensó que los mortífagos conozcan todos los mismos hechizos, pero su daño
		// es en base a su nivel mágico
